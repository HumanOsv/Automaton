...
sub report_convergence {
	...
	print FILE "\n";
	print FILE "    ___  _   _ _____ ________  ___  ___ _____ _____ _   _             \n";
	print FILE "   / _ \\| | | |_   _|  _  |  \\/  | / _ \\_   _|  _  | \\ | |        \n";
	print FILE "  / /_\\ \\ | | | | | | | | | .  . |/ /_\\ \\| | | | | |  \\| |       \n";
	print FILE "  |  _  | | | | | | | | | | |\\/| ||  _  || | | | | | . ` |           \n";
	print FILE "  | | | | |_| | | | \\ \\_/ / |  | || | | || | \\ \\_/ / |\\  |       \n";
	print FILE "  \\_| |_/\\___/  \\_/  \\___/\\_|  |_/\\_| |_/\\_/  \\___/\\_| \\_/  \n";
	print FILE "\n";                                                        
	print FILE "      A novel program for the search of global minimum            \n";
	print FILE "         structures of atomic clusters and molecules              \n";
	print FILE "                    in the gas phase.                           \n\n\n";
...
sub print_logo {
	...
	print "\n";                                                        
	print "      A novel program for the search of global minimum            \n";
...
print FILEREP "\n";                                                        
print FILEREP "      A novel program for the search of global minimum            \n";
...
while ( $convergence_count < 1 ) {
	...
	my @rep_NImag	  = ();
	if ( $option_software == 0) {
		print FILEREP "MESSAGE Send $gaussian_version\n";
		...
		print FILEREP "MESSAGE End $gaussian_version\n";	
		@opt_name      = @{$file_opt};
